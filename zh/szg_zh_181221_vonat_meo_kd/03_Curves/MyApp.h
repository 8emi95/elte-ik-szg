...
protected:
	...
	ArrayBuffer			mozdony_gpuBufferPos;	// pozíciók tömbje
	ArrayBuffer			mozdony_gpuBufferNormal;	// normálisok tömbje
	ArrayBuffer			mozdony_gpuBufferTex;	// textúrakoordináták tömbje

	VertexArrayObject	vagon_vao;			// VAO objektum
	IndexBuffer			vagon_gpuBufferIndices;		// indexek
	ArrayBuffer			vagon_gpuBufferPos;	// pozíciók tömbje
	ArrayBuffer			vagon_gpuBufferNormal;	// normálisok tömbje
	ArrayBuffer			vagon_gpuBufferTex;	// textúrakoordináták tömbje
