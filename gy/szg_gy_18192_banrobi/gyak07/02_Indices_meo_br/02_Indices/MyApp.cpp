...
bool CMyApp::Init()
{
	...
	Vertex vert[] =
	{
		...
		//          x,  y, z             R, G, B
		{ glm::vec3(-1, 0, -1), glm::vec3(0, 0.5, 0) },
		{ glm::vec3(1, 0, -1),  glm::vec3(1, 0.5, 0) },
		{ glm::vec3(1, 0, 1),   glm::vec3(1, 0.5, 1) },
		{ glm::vec3(-1, 0, 1),  glm::vec3(0, 0.5, 1) },
		{ glm::vec3(0, sqrt(2), 0), glm::vec3(1, 1, 1) } 
...
void CMyApp::Update()
{
	...
	m_matView = glm::lookAt(glm::vec3( 0,  3,  5),		// honnan nézzük a színteret // MEO ------------------------------------------------- 0 helyett 3
...
void CMyApp::Render()
{
	...
	*/
	...
	glDrawElements(	GL_TRIANGLES,		// primitív típus
					18,					// hany csucspontot hasznalunk a kirajzolashoz // MEO ------------------------------- 6 helyett 18
