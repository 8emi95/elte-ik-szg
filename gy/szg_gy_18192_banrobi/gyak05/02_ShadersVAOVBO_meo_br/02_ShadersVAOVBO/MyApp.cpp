...
bool CMyApp::Init()
{
	...
	{ 
		...
		// piros félbevágott háromszög 
		{glm::vec3(0.5,   0,  .9), glm::vec3(1, 0, 0)},
		{glm::vec3(  1,   1, -.9), glm::vec3(1, 0, 0)},
		{glm::vec3(  0, 0.5,  .9), glm::vec3(1, 0, 0)},
...
void CMyApp::Render()
{
	...
	// kirajzolás
	glDrawArrays(GL_TRIANGLES, 0, 5*3); // MEO ------------------------------------------ 4 helyett 5*3
