...
void CMyApp::InitTextures()
{
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_TEXTURE_WRAP_S); // vízszintesen
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_TEXTURE_WRAP_T); // függölegesen
...
void CMyApp::Render()
{
	...
	float elapsedTime = SDL_GetTicks() / 1000.0;
	float alpha = 0.5 * sin(2 * M_PI * elapsedTime / 5) + 0.5;
