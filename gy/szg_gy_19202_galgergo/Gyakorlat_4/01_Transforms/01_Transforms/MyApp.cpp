...
bool CMyApp::Init()
{
	...
	//glPolygonMode(GL_BACK, GL_LINE); //Hátlap csak körvonallal

	//
	// geometria letrehozasa
	//

	Vertex a = { glm::vec3(0, sqrt(2), 0), glm::vec3(1, 1, 1) };
	Vertex b = { glm::vec3(-1, 0, -1), glm::vec3(1, 0, 0) };
	Vertex c = { glm::vec3(-1, 0, 1), glm::vec3(0, 1, 0) };
	Vertex d = { glm::vec3(1, 0, 1), glm::vec3(0, 0, 1) };
	Vertex e = { glm::vec3(1, 0, -1), glm::vec3(1, 0, 1) };
...
void CMyApp::Update()
{
	...
	m_matView = glm::lookAt(glm::vec3(R * cos(time*2 * M_PI / 3),  -1, R * sin(time * 2 * M_PI / 3)),		// honnan nézzük a színteret
...
void CMyApp::Render()
{
	...
	*/
	...
	for (int i = 0; i < 15; i = i + 3)
	{
		...
		{
			m_matWorld = glm::translate<float>(glm::vec3(i, 0, j));
