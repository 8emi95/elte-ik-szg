...
void CMyApp::Update()
{
	...
	m_matView = glm::lookAt(glm::vec3( 5*cos(t/4),  3*cos(t/2),  5*sin(t/4)),		// honnan nézzük a színteret
...
void CMyApp::Render()
{
	...
	*/
	...
	m_matWorld = glm::mat4(1.0f);
		...
		*glm::rotate<float>(t / 4, glm::vec3(0, 0, 1));
	...
	drawPyramid(glm::mat4(1)*glm::scale(glm::vec3(2, 2, 2)));
	drawPyramid(glm::translate(glm::vec3(3, 0, 0)));
	drawPyramid(glm::translate(glm::vec3(3, 0, 3)));
	drawPyramid(glm::translate(glm::vec3(0, 0, 3)));
