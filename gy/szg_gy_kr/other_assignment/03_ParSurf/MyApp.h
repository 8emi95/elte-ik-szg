...
protected:
	...
	glm::vec3 GetPlanePos(float, float);
	glm::vec3 GetTorusPos(float, float);
	glm::vec3 GetConePos(float, float);
	glm::vec3 GetDiscPos(float, float);
	glm::vec3 GetCylinderPos(float, float);
