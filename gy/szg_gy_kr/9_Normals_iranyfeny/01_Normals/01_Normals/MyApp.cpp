...
bool CMyApp::Init()
{
	...
	m_loc_light_dir = glGetUniformLocation( m_programID, "light_dir" );
...
void CMyApp::Update()
{
    ...
    light_dir[0]=0.0;
    light_dir[1]=0.3*cos(t);
    light_dir[2]=0.3*sin(t);
;
}
...
void CMyApp::Render()
{
	...
	*/
    ...
    glUniform3f(m_loc_light_dir,light_dir[0],light_dir[1],light_dir[2]);
