...
protected:
	// segédfüggvények
	glm::vec3 GetUV_Sphere(float u, float v);
	glm::vec3 GetUV_Cylinder(float u, float v);
	glm::vec3 GetUV_Torus(float u, float v);
	glm::vec3 GetUV_Klein(float u, float v);
	glm::vec3 GetUV_Mobius(float u, float v);
