...
bool CMyApp::Init()
{
	...
	{ 
		// 1. háromszög
		//          x,  y, z             R, G, B
		{glm::vec3(-1, -1, 1), glm::vec3(1, 0, 0)}, //C
		{glm::vec3( 1, -1, 1), glm::vec3(0, 1, 0)}, //D
		{glm::vec3(-1,  1, 1), glm::vec3(0, 0, 1)}, //A

		// 2. háromszög
		{glm::vec3(-1,  1, 1), glm::vec3(0, 0, 1)}, //A
		{glm::vec3( 1, -1, 1), glm::vec3(0, 1, 0)}, //D
		{glm::vec3( 1,  1, 1), glm::vec3(1, 1, 1)}, //B

		//H3

		{glm::vec3(1, -1, 1), glm::vec3(0, 1, 0)}, //D
		{glm::vec3(1, -1, -1), glm::vec3(0, 1, 0)}, //H
		{glm::vec3(1,  1, 1), glm::vec3(1, 1, 1)}, //B
		//H4

		{glm::vec3(1,  1, 1), glm::vec3(1, 1, 1)}, //B
		{glm::vec3(1, -1, -1), glm::vec3(0, 1, 0)}, //H
		{glm::vec3(1,  1, -1), glm::vec3(1, 1, 1)}, //F
		//H5
		{glm::vec3(1, -1, -1), glm::vec3(0, 1, 0)}, //H
		{glm::vec3(-1, -1, -1), glm::vec3(1, 0, 0)},//G
		{glm::vec3(1,  1, -1), glm::vec3(1, 1, 1)}, //F

		//H6
		{glm::vec3(1,  1, -1), glm::vec3(1, 1, 1)}, //F
		{glm::vec3(-1, -1, -1), glm::vec3(1, 0, 0)},//G
		{glm::vec3(-1,  1, -1), glm::vec3(0, 0, 1)},//E
...
void CMyApp::Render()
{
	...
	*/
	...
	m_matWorld = glm::rotate<float>(SDL_GetTicks()/1000.0f, glm::vec3(1,1,0));
